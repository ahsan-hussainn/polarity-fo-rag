...
2. **Concordant published evidence** — gate score ≥100, which requires the firm's name, its site's
   named FO practice, and its repeated self-description to all agree.
...
fall back to the concordance route or stay in review (measured: 1 of 15 pending affirms). Assumes
