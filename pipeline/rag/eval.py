...
CASES = [
    ...
    {"name": "non-FO honesty (label, don't pass off as FO)",
     "q": "Tell me about Tarbox Family Office.",
     "want": lambda d: (not d["sources"]) or ("wealth manager" in d["answer"].lower()),
     "why": "Tarbox is a reclassified wealth manager and must be labelled as not a family office"},
